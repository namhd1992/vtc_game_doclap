$(document).ready(function() {
    ...
    $('.characterItem,.btnG').click(function() {
        ...
        $('#video_he').append('<video src="https://cdn.smobgame.com/template/au/images/update2/art' + id + '.mp4" class="videoFullscreen" muted="" autoplay="" loop=""></video>');
...
let dateStart = new Date(2022, 8, 5, 10, 0, 0).getTime(),
    dateEnd = new Date(2022, 8, 24, 10, 0, 0).getTime();
...
function checkScreen() {
    if ($(window).innerWidth() >= 1025) {
        $('#fullpage').fullpage({
            ...
            controlArrows: false,
            anchors: ['page--1', 'page--2', 'page--3', 'page--4', 'page--5', 'footer'],
            menu: '#menu-nav',
