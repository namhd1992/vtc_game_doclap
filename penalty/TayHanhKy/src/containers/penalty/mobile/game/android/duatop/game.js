...
export default class Game extends Phaser.Scene{
            ...
            if(points>0){
                if(p1[1]-p2[1] > 0){
                    ...
                    if(user!==null){
                        ...
                        axios.post(Ultilities.base_url() +'/thk_lobby/api/v1/race/playing', data, header).then(function (response) {
    ...
    loadInitData=()=>{
        ...
        if(info_seesion!==null){
            if(user!==null){
                ...
                axios.post(Ultilities.base_url() +'/thk_lobby/api/v1/race/connect', data, header).then(function (response) {
    ...
    updateData=()=>{
        ...
        if(user!==null){
            ...
            axios.post(Ultilities.base_url() +'/thk_lobby/api/v1/race/state', data, header).then(function (response) {
                if(response.data !==undefined){
                    if(response.data.code>=0){
    ...
    finishGame=()=>{
        ...
        if(user!==null){
            ...
            axios.post(Ultilities.base_url() +'/thk_lobby/api/v1/race/summary', data, header).then(function (response) {
                if(response.data !==undefined){
                    if(response.data.code>=0){
