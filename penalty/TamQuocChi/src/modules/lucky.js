...
export const checkRollup = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_pay/api/v1/bonus/rollup"
...
export const sessionUpcomming = (data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_catalog/api/v1/rooms/upcoming-eachroom"
...
export const sessionInPlay = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_catalog/api/v1/rooms/inplay"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: SESSION_INPLAY,
				data: response.data
...
export const getVinhDanh = (data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_catalog/api/v1/rewards/winners"
		return axios.post(url, data).then(function (response) {
			dispatch({
...
export const getTuDo = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_users/api/v1/giftbox/history"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: LUCKY_TU_DO,
				data: response.data
...
export const getHistoryTuDo = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_pay/api/v1/transaction/history"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
...
export const getItemAward = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_users/api/v1/giftbox/open"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: ITEM_AWARD,
				data: response.data
...
export const viewItemAward = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_users/api/v1/giftbox/view"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
...
export const raceConnect = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/race/connect"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: RACE_CONNECT,
				data: response.data
...
export const racePlaying = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/race/playing"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: RACE_PLAYING,
				data: response.data
...
export const raceState = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/race/state"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: RACE_STATE,
				data: response.data
...
export const raceSummary = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/race/summary"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: RACE_SUMMARY,
				data: response.data
...
export const jackpotConnect = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/jackpot/connect"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
...
export const jackpotPlaying = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/jackpot/playing"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
...
export const jackpotState = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/jackpot/state"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: JACKPOT_STATE,
				data: response.data
...
export const jackpotSummary = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/jackpot/summary"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
...
export const knockoutConnect = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/knockout/connect"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
...
export const knockoutPlaying = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/knockout/playing"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
...
export const knockoutState = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_lobby/api/v1/knockout/state"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: KNOCKOUT_STATE,
				data: response.data
...
export const betting = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_pay/api/v1/bets/place"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: BETTING,
				data: response.data
...
export const checkPlace = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_pay/api/v1/bets/check-place"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: CHECK_PLACE,
				data: response.data
...
export const getBalances = (token, data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_pay/api/v1/wallet/getbalances"
		return axios.post(url, data, header).then(function (response) {
			dispatch({
				type: BALANCES,
				data: response.data
...
export const getContentGuide = (data) => {
	...
	return dispatch => {
		...
		var url = Ultilities.base_url() + "/tqc_content/api/v1/news/firstordefault"
		return axios.post(url, data).then(function (response) {
			dispatch({
				type: CONTENT_GUIDE,
				data: response.data
