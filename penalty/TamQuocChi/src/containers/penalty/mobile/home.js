...
class Lucky_Rotation extends React.Component {
	...
	logout=()=>{
		...
		axios.post(Ultilities.base_url() +'/tqc_users/api/v1/account/logout', data, header).then(function (response) {
		...
		return (<div>
					<div class="wrap mx-auto">
						<div class="s-top position-relative">
							...
							<div class="s-btn-options d-flex justify-content-around" style={{width:"100%"}}>
								<a class="text-center" title="Đua TOP" onClick={()=>this.getSessionInPlay(1)}><img src={btn_duatop} alt="Đua TOP" width="60%" /></a>
						...
						<div class="s-bvd position-relative">
							<ul class="nav justify-content-center flex-nowrap font-3vw">
								<li class="nav-item text-nowrap" style={{width: "30%"}}>
									<a class={bxh_tab_1 ? "nav-link p-0 text-center text-white pt-1 font-UTMFacebookKT active" : "nav-link p-0 text-center text-white pt-1 font-UTMFacebookKT"} title="BXH cá nhân" onClick={()=>this.getVinhDanh(1,1)}>BXH CÁ NHÂN</a>
								</li>
								<li class="nav-item text-nowrap" style={{width: "30%"}}>
									<a class={bxh_tab_2 ? "nav-link p-0 text-center text-white pt-1 font-UTMFacebookKT active" : "nav-link p-0 text-center text-white pt-1 font-UTMFacebookKT"} title="BXH game" onClick={()=>this.getVinhDanh(2,1)}>BXH GAME</a>
								</li>
								<li class="nav-item text-nowrap" style={{width: "30%"}}>
									<a class={bxh_tab_3 ? "nav-link p-0 text-center text-white pt-1 font-UTMFacebookKT active" : "nav-link p-0 text-center text-white pt-1 font-UTMFacebookKT"} title="Coming soon" onClick={()=>this.getVinhDanh(3,1)}>COMING SOON</a>
								</li>
							</ul>
								...
								<div class="tab-pane container active" id="duatop">
									<table class="table table-bordered text-white font-3vw font-UTMFacebookKT mt-2 mx-auto mb-0 text-center" style={{width: "90%"}}>
										...
										<tr class="border-top-0 p-0">
											<th class="border-start-0 border-top-0 p-0">TOP</th>
											<th class="border-top-0 p-0 ps-1">Tài Khoản</th>
											<th class="border-end-0 border-top-0 p-0 ps-1">Số Bàn</th>
										</tr>
										</thead>
										<tbody>
							...
							{(bxh_tab_2)?(<div class="tab-content">
								<div class="tab-pane container active" id="duatop">
									<table class="table table-bordered text-white font-3vw font-UTMFacebookKT mt-2 mx-auto mb-0 text-center" style={{width: "90%"}}>
										<thead>
										<tr class="border-top-0 p-0">
											<th class="border-start-0 border-top-0 p-0">Top Game</th>
											<th class="border-top-0 p-0 ps-1">Tên Game</th>
											<th class="border-end-0 border-top-0 p-0 ps-1">Số Bàn</th>
										</tr>
										</thead>
										<tbody>
						...
						<div class="s-bottom position-relative">
							<div class="d-flex justify-content-around pt-4">
								...
								<a style={{width:"40%"}} href="https://scoin.vn/nap-cknh/119" title="" target="_blank"><img src={btn_ntbsk} alt="Nhận thông báo sự kiện" width="100%" /></a>
							</div>
							<div class="d-flex justify-content-around pt-2">
								<a style={{width:"40%"}} href="https://scoin.vn/nap-cknh/119" title="" target="_blank"><img src={btn_napgame} alt="Nạp Game" width="100%" /></a>
							...
							<div class="d-flex justify-content-around align-items-center group-logo mt-4">
								<a class="px-4" style={{width:"18%"}} href="#" title="" target="_blank"><img src={logo_tq} alt="Scoin" width="100%" /></a>
								<a class="px-4" style={{width:"26%"}} href="#" title="" target="_blank"><img src={logo_thk} alt="Splay" width="100%" /></a>
